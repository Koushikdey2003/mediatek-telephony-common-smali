...
.method public constructor blacklist <init>(Landroid/os/Handler;Lcom/android/internal/telephony/uicc/IccFileHandler;Landroid/content/Context;I)V
    .locals 2
...
# virtual methods
.method public blacklist decodeMessageParams(Lcom/android/internal/telephony/cat/RilMessage;)Z
    .locals 5
    ...
    .line 121
    :try_start_1
    iget-object v2, p0, Lcom/mediatek/internal/telephony/cat/MtkRilMessageDecoder;->mCmdParamsFactory:Lcom/android/internal/telephony/cat/CommandParamsFactory;
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->make(Lcom/android/internal/telephony/cat/BerTlv;)V
    :try_end_1
    ...
    .line 130
    iget-object v3, p0, Lcom/mediatek/internal/telephony/cat/MtkRilMessageDecoder;->mCurrentRilMessage:Lcom/android/internal/telephony/cat/RilMessage;

    iput v1, v3, Lcom/android/internal/telephony/cat/RilMessage;->mId:I

    .line 131
    iget-object v1, p0, Lcom/mediatek/internal/telephony/cat/MtkRilMessageDecoder;->mCurrentRilMessage:Lcom/android/internal/telephony/cat/RilMessage;
    ...
    iput-object v3, v1, Lcom/android/internal/telephony/cat/RilMessage;->mResCode:Lcom/android/internal/telephony/cat/ResultCode;

    .line 132
    iget-object v1, p0, Lcom/mediatek/internal/telephony/cat/MtkRilMessageDecoder;->mCurrentRilMessage:Lcom/android/internal/telephony/cat/RilMessage;

    invoke-virtual {p0, v1}, Lcom/mediatek/internal/telephony/cat/MtkRilMessageDecoder;->sendCmdForExecution(Lcom/android/internal/telephony/cat/RilMessage;)V
...
.method protected blacklist sendCmdForExecution(Lcom/android/internal/telephony/cat/RilMessage;)V
    .locals 4
    .param p1, "rilMsg"    # Lcom/android/internal/telephony/cat/RilMessage;
